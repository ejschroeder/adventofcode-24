package lol.schroeder.aoc24.util
...
class MutableListGrid<E> private constructor(private val elements: MutableList<E>, override val width: Int): MutableGrid<E>, Collection<E> by elements {
    ...
    override operator fun get(coordinate: Coordinate) = elements[indexOf(coordinate)]

    override operator fun get(x: Int, y: Int) = elements[indexOf(x, y)]
